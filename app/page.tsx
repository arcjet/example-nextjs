    ...
    <main className="page">
      ...
      <div className="section">
        ...
        <div className="section__actions">
          ...
          <Link href="/rate-limiting" className="button button--primary">
            Rate limiting
          </Link>
          <Link href="/attack" className="button button--primary">
            Attack protection
          </Link>
          <Link href="/sensitive-info" className="button button--primary">
            Sensitive info
          </Link>
        </div>
      </div>
